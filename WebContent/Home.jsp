				...
				<div class="main_banner_area text-center">
					<div class="col-md-5 col-sm-5 col-md-offset-7 col-sm-offset-7">
						<div class="single_banner_text wow zoomIn" data-wow-duration="1s">
							<p>Welcome to FoodWeb.com</p>
							
							<div class="separetor"></div>
						</div>
						
						<div class="link_to_recipe" data-wow-duration="1s">
								<!-- <p><a href="Ingredients_page.jsp"> Click here to find recipes </a></p> -->
								<p><a href="Query.jsp"> Click here to find recipes </a></p>
						</div>
					</div>
				...
				<div class="features_content text-center">
					<div class="col-md-4">
						<div class="sinle_features wow slideInUp" data-wow-duration="1s">
							...
							<h5>Ingredients</h5>
							<p>Tell us the your favorite ingredients and those you hate </p>
						</div>
					</div>
					<div class="col-md-4">
						<div class="sinle_features wow slideInUp" data-wow-duration="1.5s">
							<img src="images/icon1.png" alt="" />
							<h5>Recipe and Nutiton</h5>
							<p>We will tell you the best dish you can make... with the nutrition value!!</p>
						</div>
					</div>
					<div class="col-md-4">
						<div class="sinle_features wow slideInUp" data-wow-duration="2s">
							<img src="images/icon1.png" alt="" />
							<h5>Restaurants</h5>
							<p>Hate to cook? Here are the restaurants you can try out!</p>
						</div>
					</div>
				</div>
			</div>
				...
				<div class="main_abouts">
					<div class="col-md-6 col-sm-6 col-xs-12">
						<div class="single_abouts wow slideInLeft" data-wow-duration="2s">
							...
							<p>
							Food loving members of <b>Team 5 Anuradha,Avinash,Karan and Nirmala</b>,
							presents you <b><i>FOOD WEB.</i></b></p>

							<p>
							This is a semantic web project, which connects different domains ingredients, recipe,nutrition and restaurants together.Food web suggests you recipe with nutrition information ,to cook based on ingredients you supply.This project 
						    is in beta version. </p>
						</div>
					</div>
						...
						<div class="main_contact_content">
							<div class="row">
								...
								<div class="col-sm-6">
									<div class="single_contact text-left">
										<h5>Reach us at </h5>
										<span>FoodWeb123@googlegroups.com </span> 
										<span>+480-527-1311</span>
									</div>
								</div>
							</div>
